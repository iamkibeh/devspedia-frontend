...
function Signup({ addNewUser }) {
    ...
    return (
        <div class = "signup-box">
            <h2><b>Signup</b></h2>
            <h3><b>Welcome to Devspedia</b></h3>
            <h4> <i>Signup to get unlimited access to articles  </i></h4>
            <br></br>
            <form  className = 'formWrapper' onSubmit = {handleSubmit} autoComplete="off">
            <div class = "user-box">
                <label className = 'label' htmlFor = 'firstname'></label>
                <input className = 'input' id = 'firstname' type = 'text' name = 'firstname' placeholder = 'First Name' value = {formState.firstname} onChange = {formChange} required />
            </div>
            <br></br>
            <div class = "user-box">
                <label className = 'label' htmlFor = 'lastname'></label>
                <input className = 'input' id = 'lastname' type = 'text' name = 'lastname' placeholder = 'Last Name' value = {formState.lastname} onChange = {formChange} required />
            </div>
            <br></br>
            <div class = "user-box">
